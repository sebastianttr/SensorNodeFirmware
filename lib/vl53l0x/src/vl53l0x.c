...
void vl53l0x_writeReg32Bit(vl53l0x_t *v, uint8_t reg, uint32_t val)
{
   i2c_cmd_handle_t i = Write(v, reg);
...
void vl53l0x_setTimeout(vl53l0x_t *v, uint16_t new_timeout)
{
...
float vl53l0x_getSignalRateLimit(vl53l0x_t *v)
{
